...
// Extended ChainId to include Base Chain
export const ExtendedChainId = {
  ...ChainId,
  Base: 8453 as ChainId,
} as const;

type ExtendedChainIdType = typeof ChainId | 8453;
...
function valueByChainId<T>(rest: Partial<{ [key in ChainId]: T }> & { [key: number]: T }, defaultValue: T): { [key in ChainId | 8453]: T } {
  ...
  return {
    ...
    [8453]: defaultValue, // Base Chain
    ...rest,
  } as { [key in ChainId | 8453]: T };
}

/**
 * Valid sources for market sell.
 */
export const SELL_SOURCE_FILTER_BY_CHAIN_ID: Record<ChainId | 8453, SourceFilters> = {
  [ChainId.Mainnet]: new SourceFilters([
    ERC20BridgeSource.Native,
    ERC20BridgeSource.Uniswap,
    ERC20BridgeSource.UniswapV2,
    ERC20BridgeSource.UniswapV3,
    ERC20BridgeSource.UniswapV4,
  ...
  [ChainId.Celo]: new SourceFilters([ERC20BridgeSource.UbeSwap, ERC20BridgeSource.SushiSwap, ERC20BridgeSource.MultiHop, ERC20BridgeSource.MobiusMoney]),
  ...
  [8453]: new SourceFilters([
    // Base Chain
    ERC20BridgeSource.Native,
    ERC20BridgeSource.UniswapV2,
    ERC20BridgeSource.UniswapV3,
    ERC20BridgeSource.UniswapV4, // Now enabled with fallback implementation
    ERC20BridgeSource.SushiSwap,
    ERC20BridgeSource.BalancerV2,
    ERC20BridgeSource.MultiHop,
    ERC20BridgeSource.WOOFi,
 ...
 */
export const BUY_SOURCE_FILTER_BY_CHAIN_ID: Record<ChainId | 8453, SourceFilters> = {
  [ChainId.Mainnet]: new SourceFilters([
    ERC20BridgeSource.Native,
    ERC20BridgeSource.Uniswap,
    ERC20BridgeSource.UniswapV2,
 ...
 */
// export const BUY_SOURCE_FILTER_BY_CHAIN_ID: Record<ChainId | 8453, SourceFilters> = {
// DUPLICATE SECTION REMOVED - Use the first definition above
...
export const FEE_QUOTE_SOURCES_BY_CHAIN_ID = valueByChainId<ERC20BridgeSource[]>(
  {
    ...
    [8453]: [ERC20BridgeSource.UniswapV2, ERC20BridgeSource.UniswapV3, ERC20BridgeSource.UniswapV4, ERC20BridgeSource.SushiSwap], // Base Chain
  },
  [],
);
...
export const MAINNET_TOKENS = {
  ...
  KNC: "0defa4e8a7bcba345f687a2f1456f5edd9ce97202",
...
export const POLYGON_TOKENS = {
  ...
  WMATIC: "0x0d500b1d8e8ef31e21c99d1db9b6444d3adf1270",
...
export const BASE_TOKENS = {
  ...
  cbETH: "0x2ae3f1ec7f1f5012cfeab0185bfc7aa3cf0dec22", // Coinbase Ethereum
  WBTC: "0x1a35ee4640b0a3b87705b0a4b85d0c79d55e8dbf",
  axlUSDC: "0xeb466342c4d449bc9f53a865d5cb90586f405215", // Axelar USDC
  TOSHI: "0x8544fe9d190fd7ec52860abde67c05a2b3e7f364",
};
...
export const WOOFI_ROUTER_BY_CHAIN_ID = valueByChainId<string>(
  {
    ...
    [8453]: "0x27425e9fb6a9a625e8484cfd9620851d1fa322e5", // Base Chain
  },
  NULL_ADDRESS,
);
...
export const DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID: Record<ChainId | 8453, string[]> = {
  [ChainId.Mainnet]: [MAINNET_TOKENS.WETH, MAINNET_TOKENS.USDT, MAINNET_TOKENS.DAI, MAINNET_TOKENS.USDC, MAINNET_TOKENS.WBTC],
  [ChainId.BSC]: [BSC_TOKENS.WBNB, BSC_TOKENS.BUSD, BSC_TOKENS.DAI, BSC_TOKENS.USDC, BSC_TOKENS.WETH, BSC_TOKENS.USDT, BSC_TOKENS.WEX],
  [ChainId.Goerli]: [
  ...
  [ChainId.Polygon]: [POLYGON_TOKENS.WMATIC, POLYGON_TOKENS.WETH, POLYGON_TOKENS.USDC, POLYGON_TOKENS.DAI, POLYGON_TOKENS.USDT, POLYGON_TOKENS.WBTC],
  [ChainId.Avalanche]: [
    AVALANCHE_TOKENS.WAVAX,
    AVALANCHE_TOKENS.WETH,
  ...
  [ChainId.Fantom]: [FANTOM_TOKENS.WFTM, FANTOM_TOKENS.WETH, FANTOM_TOKENS.DAI, FANTOM_TOKENS.USDC, FANTOM_TOKENS.nUSD, FANTOM_TOKENS.nETH, FANTOM_TOKENS.MIM],
  [ChainId.Celo]: [CELO_TOKENS.WCELO, CELO_TOKENS.mCUSD, CELO_TOKENS.WETHv1, CELO_TOKENS.amCUSD, CELO_TOKENS.WBTC, CELO_TOKENS.cUSD],
  [ChainId.Optimism]: [OPTIMISM_TOKENS.WETH, OPTIMISM_TOKENS.DAI, OPTIMISM_TOKENS.USDC, OPTIMISM_TOKENS.USDT, OPTIMISM_TOKENS.nETH, OPTIMISM_TOKENS.sWETH],
  [ChainId.Arbitrum]: [ARBITRUM_TOKENS.USDC, ARBITRUM_TOKENS.USDT, ARBITRUM_TOKENS.WETH, ARBITRUM_TOKENS.WBTC, ARBITRUM_TOKENS.FRAX, ARBITRUM_TOKENS.MIM],
  [8453]: [
    // Base Chain
    BASE_TOKENS.WETH,
    BASE_TOKENS.USDC,
...
export const DEFAULT_TOKEN_ADJACENCY_GRAPH_BY_CHAIN_ID: Record<ChainId | 8453, TokenAdjacencyGraph> = {
  ...
  [ChainId.Arbitrum]: new TokenAdjacencyGraphBuilder(DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[ChainId.Arbitrum]).build(),
  [8453]: new TokenAdjacencyGraphBuilder(DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[8453]) // Base Chain
    .tap((builder) => {
      // Add specific token connections for Base
      builder.addBidirectional(BASE_TOKENS.USDC, BASE_TOKENS.USDbC);
      builder.addBidirectional(BASE_TOKENS.WETH, BASE_TOKENS.cbETH);
    })
    .build(),
  ...
  [ChainId.PolygonMumbai]: new TokenAdjacencyGraphBuilder(DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[ChainId.PolygonMumbai]).build(),
};
...
export const NATIVE_FEE_TOKEN_BY_CHAIN_ID = valueByChainId<string>(
  {
    ...
    [8453]: BASE_TOKENS.WETH, // Base Chain - Use WETH address directly
  },
  NULL_ADDRESS,
);
...
export const NATIVE_FEE_TOKEN_AMOUNT_BY_CHAIN_ID = valueByChainId(
  {
    ...
    [8453]: ONE_ETHER.times(0.1), // Base Chain
  },
  ONE_ETHER,
);
...
export const UNISWAPV2_ROUTER_BY_CHAIN_ID = valueByChainId<string>(
  {
    ...
    [8453]: "0x4752ba5dbc23f44d87826276bf6fd6b1c372ad24", // BaseSwap (UniswapV2 compatible) on Base
  },
  NULL_ADDRESS,
);
...
export const SUSHISWAP_ROUTER_BY_CHAIN_ID = valueByChainId<string>(
  {
    ...
    [8453]: "0x6BDED42c6DA8FBf0d2bA55B2fa120C5e0c8D7891", // Base Chain
  },
  NULL_ADDRESS,
);
...
export const BALANCER_V2_VAULT_ADDRESS_BY_CHAIN = valueByChainId<string>(
  {
    ...
    [8453]: "0xba12222222228d8ba445958a75a0704d566bf2c8", // Base Chain
  },
  NULL_ADDRESS,
);
...
export const BALANCER_V2_SUBGRAPH_URL_BY_CHAIN = valueByChainId(
  {
    ...
    [8453]: "https://api.studio.thegraph.com/query/24660/balancer-base-v2/version/latest", // Base Chain
  },
  null,
);
...
export const DEFAULT_GAS_SCHEDULE: GasSchedule = {
  ...
  [ERC20BridgeSource.UniswapV3]: (fillData?: FillData) => {
    ...
    if (isFinalPathFillData(uniFillData)) {
      ...
      const medianGasUsedForPath = pathAmountsWithGasUsed[Math.floor(pathAmountsWithGasUsed.length / 2)]?.gasUsed ?? 0;
  ...
  [ERC20BridgeSource.UniswapV4]: (fillData?: FillData) => {
    // UniswapV4 has similar structure to V3 but with hook execution overhead
    const uniFillData = fillData as TickDEXMultiPathFillData | FinalTickDEXMultiPathFillData;
    // Base gas is higher than V3 due to hooks
    const base = 45e3; // 45k base (higher than V3's 34k due to hooks)
    let gas = base;
    if (isFinalPathFillData(uniFillData)) {
      gas += uniFillData.gasUsed;
    } else {
    ...
    // Fallback estimation with hook overhead
    if (gas === base) {
      gas = 120e3; // Higher than V3's 100e3 due to hooks
      const path = uniFillData.tokenAddressPath;
      if (path.length > 2) {
        gas += (path.length - 2) * 40e3; // +40k for each hop (higher than V3's 32k)
      }
    }
  ...
  [ERC20BridgeSource.WOOFi]: (fillData?: FillData) => {
    ...
    const hasQuoteToken = quoteTokenAddresses.includes(woofiFillData.takerToken) || quoteTokenAddresses.includes(woofiFillData.makerToken);
  ...
  [ERC20BridgeSource.Velodrome]: uniswapV2CloneGasSchedule,
  [ERC20BridgeSource.Aerodrome]: uniswapV2CloneGasSchedule,
};
