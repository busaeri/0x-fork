...
const SOR_CONFIG: Record<BalancerChains, SorConfig & { poolsToIgnore?: string[] }> = {
    ...
    [8453]: { // Base Chain
        chainId: 8453,
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8', // Balancer V2 Vault on Base
        ...
        connectingTokens: [
            ...
            {
                symbol: 'usdbc',
                address: '0xd9aAEc86B65D86f6A7B5B1b0c42FFA531710b6CA', // USD Base Coin
            },
        ],
        poolsToIgnore: [], // No known problematic pools yet
        lbpRaisingTokens: [
